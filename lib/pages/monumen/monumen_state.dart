...
class MonumentPageState extends State<MonumentPage> {
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              imagesCard(widget.monument.images),
              detailCard()
            ],
          ),
        ));
  ...
  Widget imagesCard(List<String> images) => Padding(
          ...
          child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    mapButton(() => _openMaps(widget.monument.pinMap))
                  ]))));

  Widget mapButton(VoidCallback onTap) => SizedBox(
